...
import { getUserArticles, deleteArticle as deleteLocalArticle } from '../data/articleStore';
...
export default function ProfilePage() {
  ...
  const [activeTab, setActiveTab] = useState<'home' | 'drafts' | 'lists' | 'about'>('home');
        ...
        {activeTab === 'drafts' && (
          <div className="max-w-[740px]">
            {draftsLoading ? (
              ...
              <div className="text-center py-12 text-neutral-500 bg-neutral-50 rounded-xl border border-neutral-100 p-8">
                <p className="text-base font-medium text-neutral-700">No drafts yet.</p>
                <Link
                  to="/write"
                  className="inline-block mt-4 bg-green-700 text-white px-6 py-2.5 rounded-full text-sm font-medium hover:bg-green-800 transition-colors shadow-sm"
                >
              ...
              <div className="flex flex-col">
                {drafts.map((draft) => (
                  <div key={draft.id} className="py-6 border-b border-neutral-100 first:pt-2">
